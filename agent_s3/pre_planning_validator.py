...
class PrePlanningValidator:
    ...
    def _validate_test_requirements(self, test_reqs: Dict[str, Any], group_index: int, feature_index: int) -> List[str]:
    ...
    def _validate_risk_assessment(self, risk_assessment: Dict[str, Any], group_index: int, feature_index: int) -> List[str]:
