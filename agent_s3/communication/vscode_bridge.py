...
class VSCodeBridgeConfig:
    ...
    def __init__(self, data: Optional[Dict[str, Any]] = None) -> None:
        # VS Code bridge always enabled for better UX
        self.enabled = True
        self.prefer_ui = True
        ...
        # All UI components enabled for best experience
        self.ui_components: Dict[str, bool] = {
            ...
            "chat_interface": True,
            "file_explorer": False,  # Keep this false as it may be resource intensive
