...
class ErrorContextManager:
    ...
    def collect_error_context(self, error_message, stack_trace=None, failed_file=None,
         max_token_count=4000):        """Collect context around an error with improved error type detection and recovery hints.
