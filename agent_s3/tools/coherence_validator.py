...
def repair_inconsistent_patterns(
    ...
    if issues and "discussion" in repaired_plan:
        ...
        for pattern_type, guide in guidelines.items():
            ...
            repaired_plan["discussion"] += f"Dominant pattern: {guide.get('dominant_style') or guide.get('dominant_approach') or guide.get('dominant_pattern') or guide.get('dominant_flow')}\n"
