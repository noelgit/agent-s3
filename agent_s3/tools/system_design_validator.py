...
def _extract_component_dependencies(system_design: Dict[str, Any]) -> Tuple[List[str],
     Dict[Tuple[str, str], int]]:    """Extract component dependencies from the system design."""
    components = []
