...
def generate_junit_report(test_name: str, validation_results: Dict[str, Any], original_request: str = "") -> str:
    ...
    testsuite.set("tests", str(len(validation_results.get("critical", [])) + len(validation_results.get("warnings", []))))
    testsuite.set("failures", str(len(validation_results.get("critical", []))))
