...
def call_llm(
    ...
    **kwargs: Any,
    ...
    Cache hits are returned without contacting the LLM service. Failed
    attempts automatically retry according to the configuration. The
    function returns both the response dictionary and the client instance
    used for the call.
