...
def call_llm(
    ...
    **kwargs: Any,
    ...
    """Invoke an LLM with retry logic and semantic caching.

    The function returns the result of invoking ``method_name`` on ``llm`` with
    robust retry logic and semantic caching.
