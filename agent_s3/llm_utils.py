...
def call_llm(
    ...
    **kwargs: Any,
    ...
    """Invoke an LLM with retry and semantic caching.

    The helper wraps :func:`call_llm_with_retry` and handles semantic cache
    lookup and storage for the provided ``llm`` instance.
