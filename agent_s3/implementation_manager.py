...
class ImplementationManager:
    ...
    def continue_implementation(self) -> Dict[str, Any]:
        ...
        if not progress:
            return {
                "success": False,
                "error": "No existing implementation progress found",
            }
    ...
    def _implement_next_task(
        self, progress: Dict[str, Any], task: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def _run_tests(self) -> Dict[str, Any]:
        ...
        if (
            hasattr(self.coordinator, "test_runner_tool")
            and self.coordinator.test_runner_tool
        ):
            try:
