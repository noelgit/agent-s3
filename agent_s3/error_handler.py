...
class ErrorHandler:
    ...
    def handle_exception(
        ...
        if should_transform and not isinstance(exc, AgentError):
            ...
            from agent_s3.errors import (
                PlanningError, GenerationError, CoordinationError,
                AuthenticationError, NetworkError, DatabaseError, DebuggingError
            )
            ...
            if category in [ErrorCategory.PLANNING, ErrorCategory.SCHEMA, ErrorCategory.VALIDATION]:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            for attempt in range(1, max_attempts + 1):
                try:
                    ...
                    if should_retry_func and not should_retry_func(exc, attempt):
                        logger.warning(
