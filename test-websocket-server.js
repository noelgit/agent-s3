...
function sendSampleStream(ws) {
  ...
  const message =
    "This is a test of the streaming functionality. The message is broken into multiple chunks to simulate real-time streaming of content from the server to the client.";
