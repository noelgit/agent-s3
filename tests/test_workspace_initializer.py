...
class TestWorkspaceInitializer:
    ...
    @pytest.fixture
    def workspace_initializer(self, mock_config, mock_file_tool, mock_scratchpad, mock_prompt_moderator):
        """Create a WorkspaceInitializer instance with mocks."""
    ...
    def test_initialize_workspace_creates_directories(self, mock_mkdir, mock_exists, workspace_initializer):
        """Test that initialize_workspace creates the .github directory."""
        # Setup
    ...
    def test_initialize_workspace_validates_readme(self, workspace_initializer, mock_prompt_moderator):
        """Test that initialize_workspace validates README.md."""
        # Setup
