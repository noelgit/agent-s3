...
class TestFeatureBasedWorkflow:
    ...
    def test_warning_for_high_complexity_many_feature_groups(self, mock_coordinator,
         sample_pre_planning_result):        """Test that a warning is shown for high complexity with many feature groups."""
