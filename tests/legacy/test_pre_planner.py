...
class TestPrePlanner:
    ...
    def test_generate_pre_planning_data_without_json_enforcement(self,
         pre_planner_no_json_enforcement):        """Test generating pre-planning data with JSON enforcement disabled."""
        # Call method
    ...
    def test_regenerate_pre_planning_with_modifications_json_enforcement(self, mock_regenerate,
         pre_planner, sample_pre_planning_data):        """Test regenerating pre-planning data with JSON enforcement enabled."""
        # Setup mock
    ...
    def test_regenerate_pre_planning_with_modifications_no_json_enforcement(self,
         pre_planner_no_json_enforcement, sample_pre_planning_data):        """Test regenerating pre-planning data with JSON enforcement disabled."""
        # Call method
    ...
    def test_attempt_repair_with_json_validator(self, mock_validator_class, pre_planner,
         sample_pre_planning_data):        """Test repair attempt using the JSON validator."""
        # Setup mock
