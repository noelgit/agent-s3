            ...
            "unit_tests": [
                {
                    ...
                    "code": "def test_login_unauthorized_access()
                        :\n    # Test unauthorized access\n    assert auth.login('invalid', 'wrong')
                         == False",                    "setup_requirements": "Mock auth service"
                }
            ],
            "security_tests": [
                {
                    ...
                    "code": "def test_sql_injection_prevention()
                        ...
                        (malicious_input, 'any') == False",                    "setup_requirements": "Security test environment"
                }
            ],
            "performance_tests": [
                {
            ...
            "unit_tests": [
                {
                    ...
                    "test_name": "test_login_success",
                    "description": "Test successful login",
                    "code": "def test_login_success():\n    assert auth.login('valid', 'correct')
                         == True",                    "setup_requirements": "Mock auth service"
                }
            ],
            "security_tests": [
                {
                    ...
                    "code": "def test_login_security():\n    assert auth.login('invalid', 'wrong')
                         == False",                    "setup_requirements": "Security test environment"
                }
            ],
            "performance_tests": [
                {
                    ...
                    "code": "def test_api_speed():\n    start = time.time()\n    api.fetch_data()
                        \n    end = time.time()\n    assert end - start < 0.1",                    "setup_requirements": "Time measurement"
                }
            ],
            "integration_tests": [
                {
                    ...
                    "code": "def test_api_client_fetch():\n    response = client.fetch('/test')
                        \n    assert response.status == 200",                    "setup_requirements": "Mock server"
                }
            ],
            "property_based_tests": [],
            "acceptance_tests": []
            ...
            "performance_tests": [
                {
                    ...
                    "code": "def test_api_benchmark():\n    start = time.time()\n    api.fetch_data(
                          ...
                          # No pytest-benchmark                    "setup_requirements": "Time measurement"
                }
            ],
            "integration_tests": [],
            "property_based_tests": [],
