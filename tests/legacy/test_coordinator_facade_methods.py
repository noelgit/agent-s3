...
class TestCoordinatorFacadeMethods:
    ...
    def test_command_processor_design_integration_real(self, real_command_processor,
         real_coordinator):        """CommandProcessor should complete design flow using real coordinator."""
